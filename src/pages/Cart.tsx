...
//         {/* Header Section - Now Center Aligned */}
//         <div className="max-w-3xl mb-12 mx-auto text-center" data-aos="fade-up">
//           <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.25em] text-accent">
//             <span className="h-px w-8 bg-accent" /> Your Enquiry <span className="h-px w-8 bg-accent" />
//           </span>
...
const Cart = () => {
  ...
  return (
    ...
    <section className="container-px py-12 overflow-x-hidden">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-3xl mb-12 mx-auto text-center" data-aos="fade-up">
          ...
          <p className="mt-4 text-muted-foreground text-lg px-4">
            Confirm your selection below and send your enquiry via WhatsApp —
            our team will share pricing, availability and delivery details
            within business hours.
          </p>
        ...
        {items.length === 0 ? (
          <div
            className="rounded-3xl bg-card border border-border/60 p-8 sm:p-16 text-center shadow-soft mx-4"
            data-aos="fade-up"
          >
            <div className="mx-auto h-20 w-20 rounded-full bg-primary/10 grid place-items-center text-primary mb-6">
              <ShoppingBag className="h-9 w-9" />
          ...
          /* Ensure grid doesn't force width */
          <div className="grid lg:grid-cols-3 gap-8 w-full">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item, i) => (
                <div
                  ...
                  data-aos="fade-up"
                  data-aos-delay={i * 60}
                  className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center sm:items-start bg-card rounded-3xl p-4 sm:p-5 border border-border/60 shadow-soft"
                >
                  <div className="h-24 w-24 sm:h-28 sm:w-28 shrink-0 rounded-2xl overflow-hidden bg-muted">
                    <img
                      src={item.image}
            ...
            {/* Sticky Summary Card */}
            <aside
              className="lg:sticky lg:top-28 self-start bg-gradient-leaf text-primary-foreground rounded-3xl p-6 sm:p-7 shadow-elegant"
              data-aos="fade-up" /* Changed from fade-left to fade-up to prevent side overflow on mobile */
            >
              <h2 className="font-display text-2xl font-semibold">Enquiry Summary</h2>
              <p className="mt-2 text-sm text-primary-foreground/85">
                Pricing &amp; availability will be shared by our team via WhatsApp.
