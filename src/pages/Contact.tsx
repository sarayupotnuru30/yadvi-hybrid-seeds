...
// import { Clock, Instagram, MapPin, Phone, Send, Mail } from "lucide-react";
...
//             data-aos="fade-right"
//           >
//             <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-sun/25 blur-3xl pointer-events-none" />
//             <div className="absolute -bottom-24 -left-16 h-64 w-64 rounded-full bg-accent/30 blur-3xl pointer-events-none" />
...
//                   <SelectTrigger className="w-full h-12 rounded-2xl border-border bg-background px-4 text-foreground overflow-hidden">
...
import { FormEvent, useState } from "react";
import { Clock, Instagram, MapPin, Phone, Send, Mail, Facebook } from "lucide-react";
import { toast } from "sonner";
import {
  Select,
  SelectContent,
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-3">
                  <a
                    href="https://www.facebook.com/share/183q5u7jLP/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                    className="h-11 w-11 rounded-full bg-background/15 grid place-items-center hover:bg-background hover:text-primary transition-all hover:scale-110"
