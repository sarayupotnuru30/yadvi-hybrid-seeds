...
const About = () => {
  return (
    <>
      {/* Unified Background Wrapper for the "About" narrative sections */}
      ...
      {/* Founder's Note - Keeping its specific styling */}
      <section className="bg-gradient-warm py-24 container-px border-t border-border/40">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12" data-aos="fade-up">
            <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.25em] text-accent">
              <span className="h-px w-8 bg-accent" /> Founder's Note
