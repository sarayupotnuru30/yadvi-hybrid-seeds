...
const Home = () => {
  ...
  return (
    <div className="overflow-x-hidden"> {/* Wrapper to prevent horizontal scroll */}
      {/* HERO */}
      <section className="relative -mt-24 min-h-[100vh] flex items-end overflow-hidden">
        <img
          src={heroImg}
        ...
        {/* Floating decorations - Added pointer-events-none and tighter positioning */}
        <div className="absolute top-32 right-0 hidden md:block animate-float-slow pointer-events-none">
          <div className="h-20 w-20 rounded-full bg-sun/30 backdrop-blur-sm border border-sun/40 translate-x-1/2" />
        </div>
        <div className="absolute bottom-1/3 left-0 hidden md:block animate-float pointer-events-none">
          <Leaf className="h-12 w-12 text-primary-glow/70 -rotate-12 -translate-x-1/2" />
        </div>
      ...
      {/* ABOUT PREVIEW */}
      <section className="py-24 container-px overflow-hidden">
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative" data-aos="fade-right">
            <div className="absolute -top-6 -left-6 h-32 w-32 rounded-full bg-sun/40 blur-2xl" />
            <div className="relative rounded-[2rem] overflow-hidden shadow-elegant">
      ...
      {/* CTA BAND */}
      <section className="container-px pb-24 overflow-hidden">
        <div
          className="mx-auto max-w-7xl relative overflow-hidden rounded-[2.5rem] bg-gradient-leaf p-10 md:p-16 shadow-elegant"
          data-aos="zoom-in-up"
        >
